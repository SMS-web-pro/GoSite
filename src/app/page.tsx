...
const RESULTS_DATA = [
  ...
  { emoji: "🏥", color: "#E8622A", val_en: "$3.5", val_fr: "3,5€", val_ar: "32 د.م.", en: "Insurance — CPL reduced by 62%", fr: "Assurance — CPL réduit de 62%", ar: "تأمين — تخفيض CPL بنسبة 62%", desc_en: "CPL went from $9 to $3.5. 400+ qualified leads/month via Meta Ads Lead Gen.", desc_fr: "CPL passé de 7,5€ à 3,5€. 400+ leads qualifiés/mois via Meta Ads Lead Gen.", desc_ar: "انخفض CPL من 85 إلى 32 درهم. أكثر من 400 عميل مؤهل/شهر عبر Meta Ads Lead Gen.", tag: "Meta Ads · Lead Gen" },
