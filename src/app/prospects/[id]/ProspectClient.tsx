...
const STAGES = [
  ...
  { id: "preview_sent", label: "Prévisualisation envoyée", icon: "👀" },
  { id: "revision", label: "En révision", icon: "✏️" },
  { id: "approved", label: "Approuvé", icon: "✅" },
  { id: "final_payment", label: "Solde en attente", icon: "💸" },
  { id: "live", label: "En ligne", icon: "🚀" },
  { id: "checkin_sent", label: "Suivi envoyé", icon: "📞" },
  { id: "completed", label: "Terminé", icon: "🎉" },
  { id: "no_response", label: "Pas de réponse", icon: "⏸️" },
  { id: "not_interested", label: "Pas intéressé", icon: "❌" },
  { id: "has_website", label: "A déjà un site", icon: "🌐" },
];
...
export default function ProspectClient({ prospect: initialProspect, business: initialBusiness, settings, campaignLanguage, campaignCurrency }: Props) {
  ...
  const advanceWorkflow = (messageStage: string) => {
    const stageMap: Record<string, string> = {
      intro: "contacted",
      followup: "contacted",
      followup_2: "no_response",
      demo: "demo_sent",
      ask_offer: "demo_sent",
      quote: "offer_sent",
      deposit: "deposit_paid",
      payment_received: "in_development",
      progress_update: "in_development",
      preview: "preview_sent",
      confirm_changes: "revision",
      final_payment: "final_payment",
      delivery: "live",
      checkin: "checkin_sent",
      referral: "completed",
      has_website: "has_website",
      not_interested: "not_interested",
      too_expensive: "offer_sent",
      cheaper: "offer_sent",
    };
